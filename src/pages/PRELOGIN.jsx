...
function PRELOGIN() {
  return (
    <div class="bg-gray-100 h-screen w-screen justify-center">
      <center class="mt-1 m-auto pt-10">
        <svg
          class="emoji-404"
        ...
        <div class=" tracking-widest mt-4">
          <span class="text-gray-500 text-6xl block mb-4">
            <span>HELLO USER!</span>
          </span>
          <span class="text-gray-500 text-xl">
            CLICK BELOW TO SIGN-IN WITH YOUR META MASS ACCOUNT
          </span>
        </div>
      </center>
      <center class="mt-6">
        <button class="relative -top-1 -left-1 bg-gray-300 py-2.5 px-5 font-medium uppercase text-gray-500 transition-all before:absolute before:top-1 before:left-1 before:-z-[1] before:h-full before:w-full before:border-2 before:border-gray-700 before:transition-all before:content-[''] hover:top-0 hover:left-0 before:hover:top-0 before:hover:left-0">
          LOGIN
        </button>
      </center>
    </div>
