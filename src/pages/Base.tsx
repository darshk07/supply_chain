  ...
  return (
    <div className="bg-gray-100 flex-1 w-screen justify-center">
      ...
      <center className="mt-6">
        <button className="relative -top-1 -left-1 bg-gray-300 py-2.5 px-5 font-medium uppercase text-gray-500 transition-all before:absolute before:top-1 before:left-1 before:-z-[1] before:h-full before:w-full before:border-2 before:border-gray-700 before:transition-all before:content-[''] hover:top-0 hover:left-0 before:hover:top-0 before:hover:left-0">
          Connect to Metamask
        </button>
      </center>
    </div>
